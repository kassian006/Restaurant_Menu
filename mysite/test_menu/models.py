...
class FullMainMenu(models.Model):
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='category_menu')
...
class Extras(models.Model):
    extras_menu = models.ForeignKey(FullMainMenu, on_delete=models.CASCADE, related_name='extras_menu', null=True, blank=True)
    title = models.CharField(max_length=233)
    price = models.DecimalField(max_digits=10, decimal_places=2)
...
class Drinks(models.Model):
    drinks_menu = models.ForeignKey(FullMainMenu, on_delete=models.CASCADE, related_name='drinks_menu', null=True, blank=True)
    title = models.CharField(max_length=233)
    price = models.DecimalField(max_digits=10, decimal_places=2)
